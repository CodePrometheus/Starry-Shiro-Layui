package com.star.system.generator.helper;
...
import com.star.system.generator.entity.FieldType;
import com.star.system.generator.entity.GeneratorConfig;
import com.star.system.generator.entity.GeneratorConstant;
...
public class GeneratorHelper {
    ...
    public void generateEntityFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> {
            c.setField(SortUtil.underscoreToCamel(StringUtils.lowerCase(c.getName())));
    ...
    public void generateMapperXmlFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> c.setField(SortUtil.underscoreToCamel(StringUtils.lowerCase(c.getName()))));
        configure.setColumns(columns);
