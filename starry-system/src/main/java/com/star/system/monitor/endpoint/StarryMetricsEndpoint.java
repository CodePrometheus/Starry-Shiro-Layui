 ...
 *
 * @Author: zzStar
 * @Date: 03-08-2021 13:48
 */
@StarryEndPoint
public class StarryMetricsEndpoint {

    private final MeterRegistry registry;

    public StarryMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public StarryMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new StarryMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class StarryMetricResponse {
        ...
        StarryMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
