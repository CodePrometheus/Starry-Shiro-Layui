...
import com.star.system.monitor.mapper.OperationLogMapper;
...
/**
 * @Author: zzStar
 * @Date: 03-06-2021 16:13
 */
@Service
@RequiredArgsConstructor
public class OperationLogServiceImpl extends ServiceImpl<OperationLogMapper, SystemLog> implements OperationLogService {
    ...
    public IPage<SystemLog> findLogs(SystemLog systemLog, QueryRequest request) {
        ...
        if (StringUtils.isNotBlank(systemLog.getCreateTimeFrom()) &&
            ...
            systemLog.setCreateTimeFrom(systemLog.getCreateTimeFrom() + StarryConstant.DAY_START_PATTERN_SUFFIX);
            systemLog.setCreateTimeTo(systemLog.getCreateTimeTo() + StarryConstant.DAY_END_PATTERN_SUFFIX);
        }
